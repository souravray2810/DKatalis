...
//  SUCCESS_SCENARIO
	...
	public void F_browser_is_open() {		
		...
		System.out.println("Firefox Browser Strated");
...
//  SUCCESS_SCENARIO
	...
	public void F1_browser_is_open() {		
	...
	public void F1_user_clicks_on_credit_debit_card() {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@href ='#/credit-card']")).click();		
	}
	@Test(priority =22)
	@And("User enters Card Nummber, Exp Date & CVV in Firefox Browser failcase")
	public void F1_user_enters_card_nummber_exp_date_cvv() {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	...
	public void F1_hits_on_pay_now() {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@href ='#/']")).click();
		System.out.println("User clicked on Pay Now button");
	}
	...
	public void F1_users_enters_the_password() throws InterruptedException {
		Thread.sleep(8000);
		WebElement iframe = driver.findElements(By.tagName("iframe")).get(0);
		driver.switchTo().frame(iframe);
		WebDriverWait wait = new WebDriverWait(driver,10);
	...
	public void F1_order_is_confirmed() throws InterruptedException  {
